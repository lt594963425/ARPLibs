...
public class CameraUtils {
    ...
    public  static void printSupportPreviewSize(Camera.Parameters params){
        ...
        for(int i=0; i< previewSizes.size(); i++){
            ...
            Log.e("CameraUtils", "previewSizes:width = "+size.width+" height = "+size.height);
        }
    ...
    public static void printSupportPictureSize(Camera.Parameters params){
        ...
        for(int i=0; i< pictureSizes.size(); i++){
            ...
            Log.e("CameraUtils", "pictureSizes:width = "+ size.width +" height = " + size.height);
        }
    }
    /**
     * 根据ID打开相机
    ...
    public static void determineDisplayOrientation(Context context) {
        if (mCamera!=null){
            int orientation = CameraUtils.calculateCameraPreviewOrientation(context);
