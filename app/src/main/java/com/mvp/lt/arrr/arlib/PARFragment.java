...
import com.mvp.lt.arplibs.PanicARApp;
...
import com.mvp.lt.arrr.arlib.view.CameraSurfaceView;
...
public class PARFragment extends Fragment implements PSKEventListener {
    ...
    protected  FrameLayout _cameraViewContent;
    protected CameraSurfaceView _cameraView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        _cameraViewContent = (FrameLayout) this._mainView.findViewWithTag("arCameraView");
//        this._cameraView.onCreateView();
        _cameraView = new CameraSurfaceView(PanicARApp.getAppContext());
        _cameraView.setVisibility(View.VISIBLE);
        _cameraViewContent.addView(_cameraView);
