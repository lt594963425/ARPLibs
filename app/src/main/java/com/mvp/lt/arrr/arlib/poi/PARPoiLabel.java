...
public class PARPoiLabel  extends PARPoi {
        ...
        if(this.ctx == null) {
            ...
            if(inflater == null) {
                ...
                if(this.onClickListener != null) {
                    this._labelView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            onClickListener.onClick(v,PARPoiLabel.this);
                        }
                    });
                }
    ...
    public void setOnClickListener(final PARPoiLabel parPoiLabel,final OnClickListener onClickListener) {
        this.onClickListener = onClickListener;
        if(this._labelView != null) {
            this._labelView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onClickListener.onClick(v,parPoiLabel);
                }
            });
        }
    ...
    public interface OnClickListener {
         ...
         */
        void onClick(View v,PARPoiLabel parPoiLabel);
    }
}
